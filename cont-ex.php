...
<html>
    ...
    <body class="w3-sand w3-content" style="max-width:1600px" onLoad="timefunction('onload', 'body', 'body')">
        ...
        <header class="w3-container w3-sand">
            <h1>Your decision has been recorded. By clicking on "OK" you will continue the decision task.</h1>
        </header>
        
        </div>
		<div class="w3-sand w3-container w3-center w3-padding">
			<a class="confirm w3-button w3-center w3-round-xlarge w3-light-blue" name="submit" href="gamble.php">OK</a>
		</div>
