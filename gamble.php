...
session_start();
//unset($_SESSION);
if(!empty($_SESSION['trialzz']) && $_SESSION['trialzz'] > 39) {
    if($_SESSION['trialzz'] == 40) {
        include('asrs.php');
    }
    elseif($_SESSION['trialzz'] == 41) {
...
if ($trial>38)// for 18 trials
{$nextPage="before_asrs.php";}
else {$nextPage="cont-ex.php";}
    
$sql="SELECT * FROM data_input WHERE row_col=$currTrial";
...
$box1=$row[3]; //Assign a variable to your value of interest
$box2=$row[4]; //Assign a variable to your value of interest
$box3=$row[1]; //Assign a variable to your value of interest
$box4=$row[2]; //Assign a variable to your value of interest
